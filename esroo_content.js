chrome.runtime.onMessage.addListener(
  function(request, sender, sendResponse){
    ...
    var plg_title_ipsum = await getLocalStorageValue('plg_title_ipsum');
    ...
    var title_elem = $('input[placeholder="Тема"]');
    console.log(title_elem);
    title_elem.val(str_title_ipsum);
    
    var plg_desc_ipsum = await getLocalStorageValue('plg_desc_ipsum');
